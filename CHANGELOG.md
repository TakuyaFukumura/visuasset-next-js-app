...
- 資産ポートフォリオ画面の表見出しを「ジャンル」から「カテゴリ」に変更

## [0.8.3] - 2026-09-01

### Fixed

- 資産推移グラフのツールチップに背景色と文字色を設定し、年情報の視認性を改善

## [0.8.2] - 2026-09-01

### Changed

- テーマ切り替えボタンのモード名テキストを非表示にし、アイコンのみで表示

## [0.8.1] - 2026-09-01

### Fixed

- テーマ設定の復元タイミングを調整し、SSR とクライアントのテーマ表示が一致しないことによる Hydration エラーを解消
